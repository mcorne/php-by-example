...
';
    ...
    {
        $this->returned_params['array1'] = $this->_filter->filter_param('__array1');
        $this->returned_params['array2'] = $this->_filter->filter_param('__array2');
        $this->returned_params['array3'] = $this->_filter->filter_param('__array3');
    }
}
